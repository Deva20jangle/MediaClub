package com.ChatBud.chatbud.service;
...
public class FirebaseService {
    ...
    public void uploadImageToFireBaseStorage(Uri uri, final OnCallBack onCallBack){
        StorageReference riversRef = FirebaseStorage.getInstance().getReference().child("Chats/Images/" + System.currentTimeMillis()+"."+getFileExtention(uri));
    ...
    public void uploadImageToFireBaseStorageGroup(Uri uri, final OnCallBack onCallBack){
        StorageReference riversRef = FirebaseStorage.getInstance().getReference().child("GroupChats/Images/" + System.currentTimeMillis()+"."+getFileExtention(uri));
        riversRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
