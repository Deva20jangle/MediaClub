        ...
        reference.child("Chats").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    try {
                        if (chats.getSenderID().equals(firebaseUser.getUid()) && chats.getReceverID().equals(receiverID) || chats.getReceverID().equals(firebaseUser.getUid()) && chats.getSenderID().equals(receiverID)) {
                            list.add(chats);
                        }
